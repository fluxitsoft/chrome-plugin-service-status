...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(((stack1 = helpers.detailedStatus || depth0.detailedStatus),stack1 ? stack1.call(depth0, depth0.status, options) : helperMissing.call(depth0, "detailedStatus", depth0.status, options)))
    ...
    + escapeExpression(((stack1 = depth0.level),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</li>\n				<li><strong>Categoria:</strong> "
    + escapeExpression(((stack1 = depth0.category),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</li>\n				<li class=\"resource_type_";
  options = {hash:{},data:data};
  buffer += escapeExpression(((stack1 = helpers.toLowerCase || depth0.toLowerCase),stack1 ? stack1.call(depth0, depth0.resource_type, options) : helperMissing.call(depth0, "toLowerCase", depth0.resource_type, options)))
    + "\">\n				<strong>Recurso:</strong> ";
  options = {hash:{},data:data};
  buffer += escapeExpression(((stack1 = helpers.constructResource || depth0.constructResource),stack1 ? stack1.call(depth0, depth0.resource_location, options) : helperMissing.call(depth0, "constructResource", depth0.resource_location, options)))
    + "</li>\n			</ul>\n		</div>\n	</li>\n	";
  return buffer;
  }
...
function program3(depth0,data) {
  ...
  stack1 = helpers.each.call(depth0, depth0.services, {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</ul>";
  return buffer;
  });
